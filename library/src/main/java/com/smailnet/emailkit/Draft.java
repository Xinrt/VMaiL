...
public final class Draft {
    ...
    private Address[] bcc;
    /**
     * Draft is an email replying another email.
     */
    private Boolean replyDraft = false;
    private Boolean replyToAll = false;
    /**
     * Message to reply
     */
    private Long replyUid;
    /**
     * The folder of the message to reply to
     */
    private String replyFolderName;
    ...
    public Draft setReplyToAll(Boolean replyToAll) {
        this.replyToAll = replyToAll;
        return this;
    }

    public Boolean getReplyDraft() {
        return replyDraft;
    }

    public Draft setReplyDraft(Boolean replyDraft) {
    ...
    public Draft setReplyUid(Long replyUid) {
        this.replyUid = replyUid;
        return this;
    }

    public String getReplyFolderName() {
        return replyFolderName;
    }

    public Draft setReplyFolderName(String replyFolderName) {
        this.replyFolderName = replyFolderName;
        return this;
    }
